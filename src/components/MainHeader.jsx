...
const MainHeader = () => {
	...
	return (
		<header
			className="flex flex-wrap items-center sm:justify-between justify-center
		sm:h-48 sm:px-20 py-4 gap-4">
			<Link
				to="/"
				className="flex items-center justify-between gap-4 text-4xl font-bold">
				<span>
			...
			<ul className="flex  items-center justify-between gap-9 text-2xl ">
				<li
					className={
						page === "shop" ? "border-b-2 border-light-red" : " "
					}>
